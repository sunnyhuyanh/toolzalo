...
CREATE TABLE users (
  ...
  scan_webhook VARCHAR(500) DEFAULT '/webhook/zalo-automation',
  send_webhook VARCHAR(500) DEFAULT '/webhook/zalo-sent-text-image',
  post_webhook VARCHAR(500) DEFAULT '/webhook/zalo-post-group',
  invite_webhook VARCHAR(500) DEFAULT '/webhook/zalo-invite-member',
  scan_members_webhook VARCHAR(500) DEFAULT '/webhook/zalo-scan-members',
